...
- [MinGW-w64](https://www.mingw-w64.org/) - Minimalist environment for C development on Windows with 64 bit support. [Various licenses, all open source](http://mingw.org/license).
